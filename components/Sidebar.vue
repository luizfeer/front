      ...
      >
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          ...
          <li class="items-center">
            <a
              ...
              href="#/landing"
            ><i class="fas fa-newspaper text-gray-500 mr-2 text-sm" />
              Landing Page</a>
          </li>
          <li class="items-center">
            <a
              class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block"
              href="#/profile"
            ><i class="fas fa-user-circle text-gray-500 mr-2 text-sm" />
              Profile Page</a>
          </li>
          <li class="items-center">
            <a
              class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block"
              href="#/login"
            ><i class="fas fa-fingerprint text-gray-500 mr-2 text-sm" />
              Login</a>
          </li>
          <li class="items-center">
            <a
          ...
          <li class="items-center">
            <a
              class="text-gray-400 text-xs uppercase py-3 font-bold block"
              href="#pablo"
            ><i class="fas fa-tools text-gray-400 mr-2 text-sm" />
              Settings (soon)</a>
          </li>
        </ul>
        <!-- Divider -->
        ...
        >
          ...
          <li class="inline-flex">
            ...
            ><i class="fab fa-css3-alt mr-2 text-gray-500 text-base" />
              CSS Components</a>
          </li>
          <li class="inline-flex">
            <a
            ...
            ><i class="fab fa-vuejs mr-2 text-gray-500 text-base" />
              VueJS</a>
          </li>
          <li class="inline-flex">
            <a
            ...
            ><i class="fab fa-react mr-2 text-gray-500 text-base" />
              React</a>
          </li>
          <li class="inline-flex">
            <a
            ...
            ><i class="fab fa-angular mr-2 text-gray-500 text-base" />
              Angular</a>
          </li>
          <li class="inline-flex">
            <a
            ...
            ><i class="fab fa-js-square mr-2 text-gray-500 text-base" />
              Javascript</a>
          </li>
        </ul>
      </div>
